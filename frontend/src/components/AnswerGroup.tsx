...
const CONFIG = {
  o:     { label: "◯", textColor: "text-green-700",  bgColor: "bg-green-50",  borderColor: "border-green-100" },
  delta: { label: "△", textColor: "text-amber-700",  bgColor: "bg-amber-50",  borderColor: "border-amber-100" },
  x:     { label: "×", textColor: "text-red-700",    bgColor: "bg-red-50",    borderColor: "border-red-100"   },
} as const;
